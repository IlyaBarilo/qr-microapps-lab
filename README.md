...
- создаёт быстрый лист Q и полный набор листов A–H с расчётом физического размера модулей для проверки печатного порога, коррекции, способов представления HTML, вариантов ручного перехода и плотности QR;
...
«Кибертрасса 2.5D» и «Киберлабиринт 2.5D» создают видимость объёма двумерными методами. Для примеров с документацией доступна кнопка «Описание примера».
