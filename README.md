...
Раздел «Черновики» автоматически сохраняет исходный HTML, незавершённый JSON, поля конструктора и настройки. После перезагрузки сохранённая работа восстанавливается без выполнения кода. Перед выбором другого примера, открытием конструктора, импортом и очисткой создаётся восстанавливаемая версия. Хранятся автосохранения последних 20 сеансов и 20 версий перед заменой содержимого.
