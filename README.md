...
- создаёт быстрый лист Q и полный набор листов A–C с расчётом физического размера модулей для проверки печатного порога, коррекции и поддержки `data:` на конкретном устройстве;
