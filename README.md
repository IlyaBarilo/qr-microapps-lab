...
Ранняя версия проекта уже использовалась на учебном занятии, однако результаты проверки телефонов тогда не протоколировались. Поэтому совместимость была проверена повторно отдельной серией; документированная выборка пока ограничена тремя Android-телефонами.
